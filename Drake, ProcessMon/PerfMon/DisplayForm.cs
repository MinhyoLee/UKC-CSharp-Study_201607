...
namespace PerfMon
{
	public class DisplayForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// MachineNameText
			// 
			this.MachineNameText.Font = new System.Drawing.Font("Arial", 8F);
			...
			this.MachineNameText.KeyDown += new System.Windows.Forms.KeyEventHandler(this.MachineNameText_KeyDown);
			// 
			// Rows
			// 
			this.Rows.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.Rows.DropDownWidth = 117;
			this.Rows.Font = new System.Drawing.Font("Arial", 8F);
			...
			this.Rows.Name = "Rows";
			this.Rows.Size = new System.Drawing.Size(56, 22);
			...
			this.menuItem1.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																					  this.MenuStopGraphics,
																					  this.MenuStartGraphics,
																					  this.MenuExit});
			this.menuItem1.Text = "&Machine Options";
			// 
			// MenuStopGraphics
			// 
			...
			this.Thickness.Font = new System.Drawing.Font("Arial", 8F);
			...
			this.Thickness.Size = new System.Drawing.Size(56, 22);
			...
			this.CountersTree.BeforeCheck += new System.Windows.Forms.TreeViewCancelEventHandler(this.CountersTree_BeforeCheck);
			// 
			// groupBox1
			// 
			...
			this.Density.Font = new System.Drawing.Font("Arial", 8F);
			this.Density.Items.AddRange(new object[] {
														 "20 pts.",
														 "30 pts.",
														 "40 pts.",
														 "50 pts.",
			...
			this.Density.Size = new System.Drawing.Size(56, 22);
			...
			this.Frequency.Font = new System.Drawing.Font("Arial", 8F);
			...
			this.Frequency.Size = new System.Drawing.Size(56, 22);
			...
			this.Columns.Font = new System.Drawing.Font("Arial", 8F);
			...
			this.Columns.Size = new System.Drawing.Size(56, 22);
			...
			// RefreshButton
			// 
			this.RefreshButton.Font = new System.Drawing.Font("Arial", 8F);
		...
		private void ShowProgress()
		{
			...
			{
				TreeProgress.Value	=	TreeProgress.Maximum;
			}
		}
		...
		private void InsertCounter(System.Diagnostics.PerformanceCounter PC)
		{
			...
			//Workaround for the Treeview check problem (passes twice through this event)
			foreach(DisplayPanel dp in GT.Controls)
			{
				if (dp.Key.Equals(DP.Key))
				{
					PanelExists = true;
					break;
				}
		...
		//Check whether a leaf node has been checked. If not then it will "Uncheck" the node
		private void CountersTree_BeforeCheck(object sender, System.Windows.Forms.TreeViewCancelEventArgs e)
		{
		...
		//Check for "Enter" while typing the machineName
		private void MachineNameText_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
